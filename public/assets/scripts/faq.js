...
async function getFAQ() {
    ...
    for (let gen = 0; gen < general.length; gen++) {
        ...
        <div class='rounded collapse-wrapper mb-2'>
            <h3 class='m-0 font-weight-bold collapser collapsed' data-toggle="collapse" aria-expanded="false" data-target="#general${gen}" style = "border-bottom: 1px solid #d3d3d3">${general[gen][0]}</h3>
    ...
    for (let gu = 0; gu < guidelines.length; gu++) {
        html += `<div class='col-12 col-lg-6'>
        <div class='rounded collapse-wrapper mb-2'>
            <h3 class='m-0 font-weight-bold collapser collapsed' data-toggle="collapse" aria-expanded="false" data-target="#guidelines${gu}" style = "border-bottom: 1px solid #d3d3d3">${guidelines[gu][0]}</h3>
