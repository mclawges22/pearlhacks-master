...
async function getResource() {
    ...
    let projects = `<h2 class="my-4">Past Projects</h2> <div class="row">`;
    let resources = `<h2 class="my-4 pt-4">Hackathon Resources</h2> <div class="row">`;
    let womenintech = `<h2 class="my-4 pt-4">Visibility in Tech</h2> <div class="row">`;
    let html = "";
